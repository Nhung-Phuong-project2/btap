...
<body>
  ...
  <nav class="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
      <h4 class="title-head" style="color:#006182;"> QUẢN LÝ THƯ VIỆN BKACAD</h4>
    <div class="collapse navbar-collapse" id="bdNavbar">
      <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
        <li class="nav-item col-6 col-md-auto">
          <a class="nav-link p-2" href="#" >Sach</a>
        </li>
        <li class="nav-item col-6 col-md-auto">
    ...
    <div class="row">
      <div class="col-lg-3 mb-3" style="width:60%;">
        ...
        <ul class="list-unstyled small text-muted">
          <li class="mb-2">
            <a class="cl_logo hidden-lg hidden-md " href="https://www.bkacad.com/"
                title="Bkacad">
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\project2\resources\views/admin/layout.blade.php ENDPATH**/ ?>